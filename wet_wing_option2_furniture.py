...
def build_wet_wing_option2_furniture(origin=(0,0,0), building_width=10.0, building_depth=6.0, exterior_wall_thickness=0.15):
    """
    Add furniture to the Potius Wet Wing Option 2.
    
    Args:
        origin: (x, y, z) tuple for building origin
        building_width: Building width in meters (X-direction) - default 10.0 for option 2
    ...
    benchtop_base.name = "WetWing2_Benchtop_Base"
    ...
    benchtop_top.name = "WetWing2_Benchtop_Surface"
