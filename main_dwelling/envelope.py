...
def _add_exterior_windows_and_doors(ox, oy, oz, WIDTH, ENCLOSED_WIDTH, LENGTH, GROUND_FLOOR_HEIGHT, EXTERIOR_WALL_THICKNESS, NORTH_RECESS, option=1):
    ...
    add_window("MD_GF_EastWall", (ox + LENGTH / 2, oy - 2.5, oz + 1.65), width=0.9, height=0.7, depth=EXTERIOR_WALL_THICKNESS, axis='X', inward_offset='-X')
    ...
    add_window("MD_FF_EastWall", (ox + LENGTH / 2, oy - 2.5, first_floor_z + 1.5), width=0.9, height=1.0, depth=EXTERIOR_WALL_THICKNESS, axis='X', inward_offset='-X')
