...
def _add_exterior_windows_and_doors(ox, oy, oz, WIDTH, ENCLOSED_WIDTH, LENGTH, GROUND_FLOOR_HEIGHT, EXTERIOR_WALL_THICKNESS, NORTH_RECESS, option=1):
    ...
    if option == 3 or option == 4:
        ...
        add_window("MD_GF_NorthWall", (ox + LENGTH / 4, north_wall_outer_face, oz+1.5), width=1.8, height=1.0, depth=EXTERIOR_WALL_THICKNESS, axis='Y', inward_offset='-Y')
    ...
    add_window("MD_FF_NorthWall", (ox + LENGTH / 4, north_wall_outer_face, window_z_first+0.5), width=1.8, height=1.0, depth=EXTERIOR_WALL_THICKNESS, axis='Y', inward_offset='-Y')
    ...
    add_window("MD_FF_EastWall", (ox + LENGTH / 2, oy + 1.0, first_floor_z + 1.5), width=1.5, height=1.0, depth=EXTERIOR_WALL_THICKNESS, axis='X', inward_offset='-X')
    add_window("MD_FF_EastWall", (ox + LENGTH / 2, oy - 2.6, first_floor_z + 1.5), width=0.9, height=1.0, depth=EXTERIOR_WALL_THICKNESS, axis='X', inward_offset='-X')
    ...
    if option == 4:
        ...
        add_door("MD_GF_SouthWall", (ox - 0.8, south_wall_y, oz), width=0.8, height=2.0, depth=EXTERIOR_WALL_THICKNESS, axis='Y', inward_offset='+Y')
        add_window("MD_GF_SouthWall", (ox - 2.8, south_wall_y, oz + 1.5), width=1.6, height=1.0, depth=EXTERIOR_WALL_THICKNESS, axis='Y', inward_offset='+Y')
