...
print("[ ] North wall (MainDwelling_NorthWall_First) is on +Y side (top of screen)")
print("[ ] South wall (MainDwelling_SouthWall_First) is on -Y side (bottom of screen)")
print("[ ] East wall (MainDwelling_EastWall_First) is on +X side (right of screen)")
print("[ ] West wall (MainDwelling_WestWall_First) is on -X side (left of screen)")
